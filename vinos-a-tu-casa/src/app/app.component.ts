...
import { LucideAngularModule, Wine as LucideWine, Phone, Mail, MessageCircle, Gift, Sparkles } from "lucide-angular"
...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-slate-950 via-red-950 to-amber-950">
        ...
        <div class="container mx-auto px-4 py-4">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
              <lucide-icon [img]="wineIcon" class="h-8 w-8 text-soft-gold"></lucide-icon>
              <h1 class="text-2xl font-bold text-white font-cormorant tracking-wide">Vinos a tu casa</h1>
            </div>
        ...
        <section class="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div class="relative z-10 text-center text-white max-w-5xl mx-auto px-4">
            <div class="animate-fade-in-up">
              <h2 class="text-7xl md:text-9xl font-bold mb-8 text-gold-gradient glow-effect font-cormorant tracking-wider">
                Vinos a tu casa
              </h2>
            </div>
            <div class="animate-fade-in-up animate-delay-200">
              <p class="text-2xl md:text-3xl mb-10 text-bronze-gold font-light font-montserrat tracking-wide">
                Experiencias únicas en cada copa
              </p>
            </div>
            <div class="animate-fade-in-up animate-delay-400">
              <p class="text-lg md:text-xl mb-16 text-gray-200 max-w-3xl mx-auto font-light leading-relaxed font-montserrat">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up animate-delay-400">
              <button
                (click)="setActiveSection('vinos')"
                class="group bg-gradient-to-r from-amber-700 via-amber-600 to-amber-500 hover:from-amber-600 hover:via-amber-500 hover:to-yellow-600 text-white px-10 py-5 text-xl font-semibold shadow-2xl border-0 transition-all duration-500 hover:scale-110 hover:shadow-amber-600/25 rounded-full flex items-center justify-center font-montserrat"
              >
                <lucide-icon [img]="wineIcon" class="mr-3 h-6 w-6 group-hover:rotate-12 transition-transform duration-300"></lucide-icon>
                Ver Vinos
              </button>
              <button
                (click)="setActiveSection('contacto')"
                class="group border-3 border-soft-gold text-soft-gold hover:bg-soft-gold hover:text-black px-10 py-5 text-xl font-semibold shadow-2xl transition-all duration-500 hover:scale-110 hover:shadow-amber-500/25 rounded-full flex items-center justify-center font-montserrat backdrop-blur-sm bg-black/20"
              >
                <lucide-icon [img]="messageCircleIcon" class="mr-3 h-6 w-6 group-hover:scale-110 transition-transform duration-300"></lucide-icon>
                Contactar
              </button>
            </div>
          </div>
      ...
      <!-- Vinos Section -->
      <main *ngIf="activeSection === 'vinos'" class="relative py-20">
        <div
        ...
        <div class="relative z-10 container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-5xl md:text-6xl font-bold text-white mb-6 font-cormorant text-gold-gradient">Nuestros Vinos</h2>
            <p class="text-xl text-bronze-gold font-light font-montserrat">Selección premium de las mejores bodegas argentinas</p>
          </div>
            ...
            >
              <div class="p-6 pb-2">
                <div class="flex gap-4">
                  ...
                  <div class="flex-1">
                    <h3 class="text-white text-lg font-cormorant font-semibold mb-1">{{ vino.title }}</h3>
              ...
              <div class="p-6 pt-0">
                ...
                <div class="mb-6">
                  <div class="text-soft-gold font-bold text-2xl font-cormorant">{{ vino.price }}</div>
                ...
                <button
                  (click)="setActiveSection('contacto')"
                  class="w-full bg-gradient-to-r from-amber-700 to-amber-600 hover:from-amber-600 hover:to-amber-500 text-white font-semibold transition-all duration-300 hover:scale-105 py-3 px-4 rounded-lg flex items-center justify-center font-montserrat shadow-lg hover:shadow-amber-600/25"
                >
      ...
      <!-- Espumantes Section -->
      <main *ngIf="activeSection === 'espumantes'" class="relative py-20">
        <div
          class="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-15"
        ...
        <div class="relative z-10 container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-5xl md:text-6xl font-bold text-white mb-6 font-cormorant text-gold-gradient">Espumantes</h2>
            <p class="text-xl text-bronze-gold font-light font-montserrat">Celebrá cada momento con nuestros espumantes premium</p>
          </div>
            ...
            >
              <div class="p-6 pb-2">
                <div class="flex gap-4">
                  ...
                  <div class="flex-1">
                    <h3 class="text-white text-lg font-cormorant font-semibold mb-1">{{ espumante.title }}</h3>
              ...
              <div class="p-6 pt-0">
                ...
                <div class="mb-6">
                  <div class="text-soft-gold font-bold text-2xl font-cormorant">{{ espumante.price }}</div>
      ...
      <!-- Promos Section -->
      <main *ngIf="activeSection === 'promos'" class="relative py-20">
        <div
          class="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-15"
          style="background-image: url('https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=1200&h=800&fit=crop');"
        ></div>
        ...
        <div class="relative z-10 container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-5xl md:text-6xl font-bold text-white mb-6 font-cormorant text-gold-gradient">Promociones Especiales</h2>
            <p class="text-xl text-bronze-gold font-light font-montserrat">Aprovechá nuestras ofertas exclusivas</p>
          </div>
            ...
            >
              <div class="p-6 pb-2">
                <div class="flex gap-4">
                  ...
                  <div class="flex-1">
                    <h3 class="text-white text-lg font-cormorant font-semibold mb-1">{{ promo.title }}</h3>
              ...
              <div class="p-6 pt-0">
                ...
                <div class="mb-6">
                  <div class="text-soft-gold font-bold text-2xl font-cormorant">{{ promo.price }}</div>
      ...
      <!-- Contacto Section -->
      <main *ngIf="activeSection === 'contacto'" class="py-20">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-5xl md:text-6xl font-bold text-white mb-6 font-cormorant text-gold-gradient">Contactanos</h2>
            <p class="text-xl text-bronze-gold font-light font-montserrat">
          ...
          <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div
              *ngFor="let contact of contactInfo"
              class="bg-black/50 backdrop-blur-sm border border-soft-gold/30 hover:border-soft-gold/60 transition-all duration-300 hover:scale-105 rounded-xl p-6 hover:shadow-2xl hover:shadow-amber-600/10"
            >
              <div class="flex items-start space-x-4">
                <div class="bg-gradient-to-br from-amber-700 to-amber-600 p-4 rounded-full shadow-lg">
                  <div *ngIf="contact.isWhatsApp; else defaultIcon" class="h-6 w-6 text-white">
                    <!-- WhatsApp SVG Icon -->
                  ...
                  <ng-template #defaultIcon>
                    <lucide-icon [img]="contact.icon" class="h-6 w-6 text-white"></lucide-icon>
                  </ng-template>
                </div>
                <div class="flex-1">
                  <h3 class="text-white font-bold text-lg mb-1 font-cormorant">{{ contact.type }}</h3>
                  <p class="text-bronze-gold text-sm mb-3 font-light font-montserrat">{{ contact.description }}</p>
                  <a
                    [href]="contact.link"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="text-soft-gold hover:text-warm-gold font-semibold text-lg transition-colors font-montserrat hover:underline"
                  >
                    {{ contact.value }}
                  </a>
                </div>
      ...
      <!-- Footer -->
      <footer class="bg-black/70 backdrop-blur-sm border-t border-soft-gold/20 py-8">
        <div class="container mx-auto px-4 text-center">
          <div class="flex items-center justify-center space-x-3 mb-4">
            <lucide-icon [img]="wineIcon" class="h-6 w-6 text-soft-gold"></lucide-icon>
            <span class="text-white font-bold text-lg font-cormorant tracking-wide">Vinos a tu casa</span>
          </div>
          <p class="text-gray-400 font-light font-montserrat">© 2024 Vinos a tu casa. Todos los derechos reservados.</p>
          <p class="text-gray-500 text-sm mt-2 font-light font-montserrat">
